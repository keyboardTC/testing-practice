...
try {
  ...
  var result = difference(1, 1, 1, 1, 12);
  if (result !== 0) throw new Error('Expected difference(1, 1, 1, 1, 12) to be 0. Received: ' + result);
  ...
  if (result !== 1) throw new Error('Expected difference(1, 1) to be 1. Received: ' + result);
